...
void dft_2_compact(const I* input, I* output, int stride=1) {
  const T kWeight0 = SimdHelper<T, I>::constant(0);
...
void dft_8_compact(const I* input, I* output, int stride=1) {
  ...
  SimdHelper<T, I>::store(output + 1 * stride, (w1 + kWeight2*( w8-w10)));
  SimdHelper<T, I>::store(output + 2 * stride, w5);
  SimdHelper<T, I>::store(output + 3 * stride, ( w1-kWeight2*( w8-w10)));
  SimdHelper<T, I>::store(output + 4 * stride, ( w4-w11));
  SimdHelper<T, I>::store(output + 5 * stride, ( -w3-kWeight2*(w10 + w8)));
  SimdHelper<T, I>::store(output + 6 * stride, -w12);
  SimdHelper<T, I>::store(output + 7 * stride, ( w3-kWeight2*(w10 + w8)));
}
template <typename T, typename I=float>
void dft_16_compact(const I* input, I* output, int stride=1) {
  ...
  const T w14  = (w4 + w11);
  const T w15  = ( w4-w11);
  const T w16[2]  =  {(T)((w1 + kWeight2*( w8-w10))), (T)(( -w3-kWeight2*(w10 + w8)))};
  const T w18[2]  =  {(T)(( w1-kWeight2*( w8-w10))), (T)(( w3-kWeight2*(w10 + w8)))};
  const T w19  = (i1 + i9);
  const T w20  = ( i1-i9);
  const T w21  = (i5 + i13);
  const T w22  = ( i5-i13);
  ...
  const T w33  = (w23 + w30);
  const T w34  = ( w23-w30);
  const T w35[2]  =  {(T)((w20 + kWeight2*( w27-w29))), (T)(( -w22-kWeight2*(w29 + w27)))};
  const T w37[2]  =  {(T)(( w20-kWeight2*( w27-w29))), (T)(( w22-kWeight2*(w29 + w27)))};
  SimdHelper<T, I>::store(output + 0 * stride, (w14 + w33));
  SimdHelper<T, I>::store(output + 1 * stride, (w16[0] + (kWeight3*w35[0] + kWeight4*w35[1])));
  SimdHelper<T, I>::store(output + 2 * stride, (w5 + kWeight2*( w24-w31)));
  ...
  SimdHelper<T, I>::store(output + 6 * stride, ( w5-kWeight2*( w24-w31)));
  ...
  SimdHelper<T, I>::store(output + 10 * stride, ( -w12-kWeight2*(w31 + w24)));
  SimdHelper<T, I>::store(output + 11 * stride, (w18[1] + ( kWeight4*w37[1]-kWeight3*w37[0])));
  SimdHelper<T, I>::store(output + 12 * stride, -w34);
  SimdHelper<T, I>::store(output + 13 * stride, ( -w18[1]-( kWeight3*w37[0]-kWeight4*w37[1])));
  SimdHelper<T, I>::store(output + 14 * stride, ( w12-kWeight2*(w31 + w24)));
  SimdHelper<T, I>::store(output + 15 * stride, ( -w16[1]-( kWeight4*w35[0]-kWeight3*w35[1])));
}
template <typename T, typename I=float>
void dft_32_compact(const I* input, I* output, int stride=1) {
  ...
  const T w41[2]  =  {(T)((w5 + kWeight2*( w24-w31))), (T)(( -w12-kWeight2*(w31 + w24)))};
  const T w42[2]  =  {(T)((w18[0] + (kWeight4*w37[0] + kWeight3*w37[1]))), (T)((w18[1] + ( kWeight4*w37[1]-kWeight3*w37[0])))};
  const T w44[2]  =  {(T)((w18[0] + ( -kWeight4*w37[0]-kWeight3*w37[1]))), (T)(( -w18[1]-( kWeight3*w37[0]-kWeight4*w37[1])))};
  const T w45[2]  =  {(T)(( w5-kWeight2*( w24-w31))), (T)(( w12-kWeight2*(w31 + w24)))};
  const T w46[2]  =  {(T)((w16[0] + ( -kWeight3*w35[0]-kWeight4*w35[1]))), (T)(( -w16[1]-( kWeight4*w35[0]-kWeight3*w35[1])))};
  const T w47  = (i1 + i17);
  const T w48  = ( i1-i17);
  const T w49  = (i9 + i25);
  const T w50  = ( i9-i25);
  ...
  const T w61  = (w51 + w58);
  const T w62  = ( w51-w58);
  const T w63[2]  =  {(T)((w48 + kWeight2*( w55-w57))), (T)(( -w50-kWeight2*(w57 + w55)))};
  const T w65[2]  =  {(T)(( w48-kWeight2*( w55-w57))), (T)(( w50-kWeight2*(w57 + w55)))};
  const T w66  = (i3 + i19);
  const T w67  = ( i3-i19);
  const T w68  = (i11 + i27);
  const T w69  = ( i11-i27);
  ...
  const T w80  = (w70 + w77);
  const T w81  = ( w70-w77);
  const T w82[2]  =  {(T)((w67 + kWeight2*( w74-w76))), (T)(( -w69-kWeight2*(w76 + w74)))};
  const T w84[2]  =  {(T)(( w67-kWeight2*( w74-w76))), (T)(( w69-kWeight2*(w76 + w74)))};
  const T w85  = (w61 + w80);
  const T w86  = ( w61-w80);
  const T w87[2]  =  {(T)((w63[0] + (kWeight3*w82[0] + kWeight4*w82[1]))), (T)((w63[1] + ( kWeight3*w82[1]-kWeight4*w82[0])))};
  const T w88[2]  =  {(T)((w52 + kWeight2*( w71-w78))), (T)(( -w59-kWeight2*(w78 + w71)))};
  const T w89[2]  =  {(T)((w65[0] + (kWeight4*w84[0] + kWeight3*w84[1]))), (T)((w65[1] + ( kWeight4*w84[1]-kWeight3*w84[0])))};
  const T w91[2]  =  {(T)((w65[0] + ( -kWeight4*w84[0]-kWeight3*w84[1]))), (T)(( -w65[1]-( kWeight3*w84[0]-kWeight4*w84[1])))};
  const T w92[2]  =  {(T)(( w52-kWeight2*( w71-w78))), (T)(( w59-kWeight2*(w78 + w71)))};
  const T w93[2]  =  {(T)((w63[0] + ( -kWeight3*w82[0]-kWeight4*w82[1]))), (T)(( -w63[1]-( kWeight4*w82[0]-kWeight3*w82[1])))};
  ...
  SimdHelper<T, I>::store(output + 4 * stride, (w15 + kWeight2*( w62-w81)));
  ...
  SimdHelper<T, I>::store(output + 12 * stride, ( w15-kWeight2*( w62-w81)));
  ...
  SimdHelper<T, I>::store(output + 20 * stride, ( -w34-kWeight2*(w81 + w62)));
  ...
  SimdHelper<T, I>::store(output + 25 * stride, ( -w46[1]-( kWeight5*w93[0]-kWeight6*w93[1])));
  SimdHelper<T, I>::store(output + 26 * stride, ( -w45[1]-( kWeight3*w92[0]-kWeight4*w92[1])));
  SimdHelper<T, I>::store(output + 27 * stride, ( -w44[1]-( kWeight7*w91[0]-kWeight8*w91[1])));
  SimdHelper<T, I>::store(output + 28 * stride, ( w34-kWeight2*(w81 + w62)));
  SimdHelper<T, I>::store(output + 29 * stride, ( -w42[1]-( kWeight8*w89[0]-kWeight7*w89[1])));
  SimdHelper<T, I>::store(output + 30 * stride, ( -w41[1]-( kWeight4*w88[0]-kWeight3*w88[1])));
  SimdHelper<T, I>::store(output + 31 * stride, ( -w40[1]-( kWeight6*w87[0]-kWeight5*w87[1])));
}
template <typename T, typename I=float>
void dft_64_compact(const I* input, I* output, int stride=1) {
  ...
  const T w99[2]  =  {(T)((w15 + kWeight2*( w62-w81))), (T)(( -w34-kWeight2*(w81 + w62)))};
  ...
  const T w104[2]  =  {(T)((w46[0] + ( -kWeight6*w93[0]-kWeight5*w93[1]))), (T)(( -w46[1]-( kWeight5*w93[0]-kWeight6*w93[1])))};
  const T w105[2]  =  {(T)((w45[0] + ( -kWeight4*w92[0]-kWeight3*w92[1]))), (T)(( -w45[1]-( kWeight3*w92[0]-kWeight4*w92[1])))};
  const T w106[2]  =  {(T)((w44[0] + ( -kWeight8*w91[0]-kWeight7*w91[1]))), (T)(( -w44[1]-( kWeight7*w91[0]-kWeight8*w91[1])))};
  const T w107[2]  =  {(T)(( w15-kWeight2*( w62-w81))), (T)(( w34-kWeight2*(w81 + w62)))};
  const T w108[2]  =  {(T)((w42[0] + ( -kWeight7*w89[0]-kWeight8*w89[1]))), (T)(( -w42[1]-( kWeight8*w89[0]-kWeight7*w89[1])))};
  const T w109[2]  =  {(T)((w41[0] + ( -kWeight3*w88[0]-kWeight4*w88[1]))), (T)(( -w41[1]-( kWeight4*w88[0]-kWeight3*w88[1])))};
  const T w110[2]  =  {(T)((w40[0] + ( -kWeight5*w87[0]-kWeight6*w87[1]))), (T)(( -w40[1]-( kWeight6*w87[0]-kWeight5*w87[1])))};
  const T w111  = (i1 + i33);
  const T w112  = ( i1-i33);
  ...
  const T w127[2]  =  {(T)((w112 + kWeight2*( w119-w121))), (T)(( -w114-kWeight2*(w121 + w119)))};
  const T w129[2]  =  {(T)(( w112-kWeight2*( w119-w121))), (T)(( w114-kWeight2*(w121 + w119)))};
  const T w130  = (i5 + i37);
  const T w131  = ( i5-i37);
  ...
  const T w146[2]  =  {(T)((w131 + kWeight2*( w138-w140))), (T)(( -w133-kWeight2*(w140 + w138)))};
  const T w148[2]  =  {(T)(( w131-kWeight2*( w138-w140))), (T)(( w133-kWeight2*(w140 + w138)))};
  ...
  const T w152[2]  =  {(T)((w116 + kWeight2*( w135-w142))), (T)(( -w123-kWeight2*(w142 + w135)))};
  const T w153[2]  =  {(T)((w129[0] + (kWeight4*w148[0] + kWeight3*w148[1]))), (T)((w129[1] + ( kWeight4*w148[1]-kWeight3*w148[0])))};
  const T w155[2]  =  {(T)((w129[0] + ( -kWeight4*w148[0]-kWeight3*w148[1]))), (T)(( -w129[1]-( kWeight3*w148[0]-kWeight4*w148[1])))};
  const T w156[2]  =  {(T)(( w116-kWeight2*( w135-w142))), (T)(( w123-kWeight2*(w142 + w135)))};
  const T w157[2]  =  {(T)((w127[0] + ( -kWeight3*w146[0]-kWeight4*w146[1]))), (T)(( -w127[1]-( kWeight4*w146[0]-kWeight3*w146[1])))};
  const T w158  = (i3 + i35);
  const T w159  = ( i3-i35);
  ...
  const T w174[2]  =  {(T)((w159 + kWeight2*( w166-w168))), (T)(( -w161-kWeight2*(w168 + w166)))};
  const T w176[2]  =  {(T)(( w159-kWeight2*( w166-w168))), (T)(( w161-kWeight2*(w168 + w166)))};
  const T w177  = (i7 + i39);
  const T w178  = ( i7-i39);
  ...
  const T w193[2]  =  {(T)((w178 + kWeight2*( w185-w187))), (T)(( -w180-kWeight2*(w187 + w185)))};
  const T w195[2]  =  {(T)(( w178-kWeight2*( w185-w187))), (T)(( w180-kWeight2*(w187 + w185)))};
  ...
  const T w199[2]  =  {(T)((w163 + kWeight2*( w182-w189))), (T)(( -w170-kWeight2*(w189 + w182)))};
  const T w200[2]  =  {(T)((w176[0] + (kWeight4*w195[0] + kWeight3*w195[1]))), (T)((w176[1] + ( kWeight4*w195[1]-kWeight3*w195[0])))};
  const T w202[2]  =  {(T)((w176[0] + ( -kWeight4*w195[0]-kWeight3*w195[1]))), (T)(( -w176[1]-( kWeight3*w195[0]-kWeight4*w195[1])))};
  const T w203[2]  =  {(T)(( w163-kWeight2*( w182-w189))), (T)(( w170-kWeight2*(w189 + w182)))};
  const T w204[2]  =  {(T)((w174[0] + ( -kWeight3*w193[0]-kWeight4*w193[1]))), (T)(( -w174[1]-( kWeight4*w193[0]-kWeight3*w193[1])))};
  ...
  const T w210[2]  =  {(T)((w126 + kWeight2*( w173-w192))), (T)(( -w145-kWeight2*(w192 + w173)))};
  ...
  const T w215[2]  =  {(T)((w157[0] + ( -kWeight6*w204[0]-kWeight5*w204[1]))), (T)(( -w157[1]-( kWeight5*w204[0]-kWeight6*w204[1])))};
  const T w216[2]  =  {(T)((w156[0] + ( -kWeight4*w203[0]-kWeight3*w203[1]))), (T)(( -w156[1]-( kWeight3*w203[0]-kWeight4*w203[1])))};
  const T w217[2]  =  {(T)((w155[0] + ( -kWeight8*w202[0]-kWeight7*w202[1]))), (T)(( -w155[1]-( kWeight7*w202[0]-kWeight8*w202[1])))};
  const T w218[2]  =  {(T)(( w126-kWeight2*( w173-w192))), (T)(( w145-kWeight2*(w192 + w173)))};
  const T w219[2]  =  {(T)((w153[0] + ( -kWeight7*w200[0]-kWeight8*w200[1]))), (T)(( -w153[1]-( kWeight8*w200[0]-kWeight7*w200[1])))};
  const T w220[2]  =  {(T)((w152[0] + ( -kWeight3*w199[0]-kWeight4*w199[1]))), (T)(( -w152[1]-( kWeight4*w199[0]-kWeight3*w199[1])))};
  const T w221[2]  =  {(T)((w151[0] + ( -kWeight5*w198[0]-kWeight6*w198[1]))), (T)(( -w151[1]-( kWeight6*w198[0]-kWeight5*w198[1])))};
  ...
  SimdHelper<T, I>::store(output + 8 * stride, (w39 + kWeight2*( w150-w197)));
  ...
  SimdHelper<T, I>::store(output + 24 * stride, ( w39-kWeight2*( w150-w197)));
  ...
  SimdHelper<T, I>::store(output + 40 * stride, ( -w86-kWeight2*(w197 + w150)));
  ...
  SimdHelper<T, I>::store(output + 49 * stride, ( -w110[1]-( kWeight9*w221[0]-kWeight10*w221[1])));
  SimdHelper<T, I>::store(output + 50 * stride, ( -w109[1]-( kWeight5*w220[0]-kWeight6*w220[1])));
  SimdHelper<T, I>::store(output + 51 * stride, ( -w108[1]-( kWeight11*w219[0]-kWeight12*w219[1])));
  SimdHelper<T, I>::store(output + 52 * stride, ( -w107[1]-( kWeight3*w218[0]-kWeight4*w218[1])));
  SimdHelper<T, I>::store(output + 53 * stride, ( -w106[1]-( kWeight13*w217[0]-kWeight14*w217[1])));
  SimdHelper<T, I>::store(output + 54 * stride, ( -w105[1]-( kWeight7*w216[0]-kWeight8*w216[1])));
  SimdHelper<T, I>::store(output + 55 * stride, ( -w104[1]-( kWeight15*w215[0]-kWeight16*w215[1])));
  SimdHelper<T, I>::store(output + 56 * stride, ( w86-kWeight2*(w197 + w150)));
  SimdHelper<T, I>::store(output + 57 * stride, ( -w102[1]-( kWeight16*w213[0]-kWeight15*w213[1])));
  SimdHelper<T, I>::store(output + 58 * stride, ( -w101[1]-( kWeight8*w212[0]-kWeight7*w212[1])));
  SimdHelper<T, I>::store(output + 59 * stride, ( -w100[1]-( kWeight14*w211[0]-kWeight13*w211[1])));
  SimdHelper<T, I>::store(output + 60 * stride, ( -w99[1]-( kWeight4*w210[0]-kWeight3*w210[1])));
  SimdHelper<T, I>::store(output + 61 * stride, ( -w98[1]-( kWeight12*w209[0]-kWeight11*w209[1])));
  SimdHelper<T, I>::store(output + 62 * stride, ( -w97[1]-( kWeight6*w208[0]-kWeight5*w208[1])));
  SimdHelper<T, I>::store(output + 63 * stride, ( -w96[1]-( kWeight10*w207[0]-kWeight9*w207[1])));
}
