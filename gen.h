...
inline void dft_16(T* input, std::complex<T>* output) {
  ...
  const std::complex<T> c13{
      f1 + f2, f2 - f1};  // kWeight2 * w13.real(), = std::complex<T>( kWeight2,
                          // -kWeight2) * w13;
  const std::complex<T> w16 = w6 + c13;
  const std::complex<T> w17 = {w5, -w12};
  const std::complex<T> w18 =
      std::conj(w6 - c13);  //  -  std::complex<T>(c13.real(), -kWeight2,
                            //  -kWeight2) * std::conj(w13);
  ...
  const std::complex<T> c32 = {
      f1 + f2, f2 - f1};  // std::complex<T>( kWeight2, -kWeight2) * w32;
  ...
  const std::complex<T> c36(
      f1 + f2, f2 - f1);  // = std::complex<T>( kWeight2, -kWeight2) * w36;
  ...
  output[5] = std::conj(
      w18 -
      c37);  //  +  std::complex<float>(-kWeight4, -kWeight3) * std::conj(w37);
  output[6] = std::conj(
      w17 -
      c36);  //  +  std::complex<float>(-kWeight2, -kWeight2) * std::conj(w36);
  output[7] = std::conj(
      w16 -
      c35);  //  +  std::complex<float>(-kWeight3, -kWeight4) * std::conj(w35);
}
// Num expressions: 143
// Weights: 9
void dft_32(float* input, std::complex<float>* output) {
  ...
  const std::complex<float> w16 =
      w6 + std::complex<float>(kWeight2, -kWeight2) * w13;
  const std::complex<float> w17 = {w5, -w12};
  const std::complex<float> w18 =
      std::conj(w6) +
      std::complex<float>(-kWeight2, -kWeight2) * std::conj(w13);
  ...
  const std::complex<float> w35 =
      w25 + std::complex<float>(kWeight2, -kWeight2) * w32;
  const std::complex<float> w36 = {w24, -w31};
  const std::complex<float> w37 =
      std::conj(w25) +
      std::complex<float>(-kWeight2, -kWeight2) * std::conj(w32);
  const float w38 = w14 + w33;
  const float w39 = w14 + -w33;
  const std::complex<float> w40 =
      w16 + std::complex<float>(kWeight3, -kWeight4) * w35;
  const std::complex<float> w41 =
      w17 + std::complex<float>(kWeight2, -kWeight2) * w36;
  const std::complex<float> w42 =
      w18 + std::complex<float>(kWeight4, -kWeight3) * w37;
  const std::complex<float> w43 = {w15, -w34};
  const std::complex<float> w44 =
      std::conj(w18) +
      std::complex<float>(-kWeight4, -kWeight3) * std::conj(w37);
  const std::complex<float> w45 =
      std::conj(w17) +
      std::complex<float>(-kWeight2, -kWeight2) * std::conj(w36);
  const std::complex<float> w46 =
      std::conj(w16) +
      std::complex<float>(-kWeight3, -kWeight4) * std::conj(w35);
  ...
  const std::complex<float> w63 =
      w53 + std::complex<float>(kWeight2, -kWeight2) * w60;
  const std::complex<float> w64 = {w52, -w59};
  const std::complex<float> w65 =
      std::conj(w53) +
      std::complex<float>(-kWeight2, -kWeight2) * std::conj(w60);
  ...
  const std::complex<float> w82 =
      w72 + std::complex<float>(kWeight2, -kWeight2) * w79;
  const std::complex<float> w83 = {w71, -w78};
  const std::complex<float> w84 =
      std::conj(w72) +
      std::complex<float>(-kWeight2, -kWeight2) * std::conj(w79);
  const float w85 = w61 + w80;
  const float w86 = w61 + -w80;
  const std::complex<float> w87 =
      w63 + std::complex<float>(kWeight3, -kWeight4) * w82;
  const std::complex<float> w88 =
      w64 + std::complex<float>(kWeight2, -kWeight2) * w83;
  const std::complex<float> w89 =
      w65 + std::complex<float>(kWeight4, -kWeight3) * w84;
  const std::complex<float> w90 = {w62, -w81};
  const std::complex<float> w91 =
      std::conj(w65) +
      std::complex<float>(-kWeight4, -kWeight3) * std::conj(w84);
  const std::complex<float> w92 =
      std::conj(w64) +
      std::complex<float>(-kWeight2, -kWeight2) * std::conj(w83);
  const std::complex<float> w93 =
      std::conj(w63) +
      std::complex<float>(-kWeight3, -kWeight4) * std::conj(w82);
  output[0] = w38 + w85;
  output[16] = w38 + -w85;
  ...
  output[8] = {w39, -w86};
  output[9] = std::conj(w46) +
              std::complex<float>(-kWeight6, -kWeight5) * std::conj(w93);
  output[10] = std::conj(w45) +
               std::complex<float>(-kWeight4, -kWeight3) * std::conj(w92);
  output[11] = std::conj(w44) +
               std::complex<float>(-kWeight8, -kWeight7) * std::conj(w91);
  output[12] = std::conj(w43) +
               std::complex<float>(-kWeight2, -kWeight2) * std::conj(w90);
  output[13] = std::conj(w42) +
               std::complex<float>(-kWeight7, -kWeight8) * std::conj(w89);
  output[14] = std::conj(w41) +
               std::complex<float>(-kWeight3, -kWeight4) * std::conj(w88);
  output[15] = std::conj(w40) +
               std::complex<float>(-kWeight5, -kWeight6) * std::conj(w87);
}
